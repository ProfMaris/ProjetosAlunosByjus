...
<p>Um Sprite é o principal bloco de construção do p5.play: um elemento capaz de armazenar imagens ou animações com um conjunto de propriedades como posição e visibilidade. Um Sprite pode ter um colisor que define a área ativa para detectar colisões ou sobreposições com outros sprites 
